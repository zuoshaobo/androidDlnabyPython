...
public class MainActivity extends AppCompatActivity {
    ...
    public void click2(View view) {
        ...
        try {
            ...
            copyFile(this, "math.cpython-39.so", null);
            copyFile(this, "select.cpython-39.so", null);
            copyFile(this, "_socket.cpython-39.so", null);
    ...
    public void click(View view) {
        ...
        if (true) {
            ...
            try {
                ...
                //System.load(this.getApplicationInfo().nativeLibraryDir + "/_socket.cpython-39.so");
            ...
            Log.d("aaaa", "/data/data/" + getPackageName() + "/files/python3.9.zip");
            ...
            pythonPath._Call("import", "_socket");

            python._Call("execute", pystring);
            Object object = python._Call("projector","/data/data/com.ang.androidmutualpython/files/xx.jpg");
